  ...
  while ((entry = readdir(dir)) != NULL) {
    ...
    // Copy regular files
      ...
      char *head_text =
          ...
          "font-family: barlow;"
          "font-weight: 500;"
          "src: url('media/fonts/Barlow-Medium.ttf');"
          "}"
          "@font-face {"
          "font-family: barlow;"
          "src: url('media/fonts/Barlow-Bold.ttf');"
          "font-weight: 700;"
          "}"
          "@font-face {"
          "font-family: barlow;"
          "src: url('media/fonts/Barlow-BoldItalic.ttf');"
          "font-weight: 700;"
          "font-style: italic;"
          "}"
          "@font-face {"
          "font-family: barlow;"
          "src: url('media/fonts/Barlow-Italic.ttf');"
          "font-style: italic;"
          "}"
          "*, ::after, ::before {"
